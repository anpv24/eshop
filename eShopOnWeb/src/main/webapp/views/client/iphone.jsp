	...
	<section class="bg0 p-t-23 p-b-140">
		<div class="container">
					...
					<div
						...
						<div class="filter-col2 p-r-15 p-b-27">
							...
							<ul>
								...
								<li class="p-b-6"><a href="/eShopOnWeb/iphoneOrder?action=price&id=min"
									class="filter-link stext-106 trans-04"> 0đ - 10.000.000đ </a>
								</li>

								<li class="p-b-6"><a href="/eShopOnWeb/iphoneOrder?action=price&id=middle"
									class="filter-link stext-106 trans-04"> 10.000.000đ - 20.000.000đ </a>
								</li>

								<li class="p-b-6"><a href="/eShopOnWeb/iphoneOrder?action=price&id=max"
			...
			<div class="row isotope-grid">
				<c:forEach items="${requestScope.iphone}" var="product">
