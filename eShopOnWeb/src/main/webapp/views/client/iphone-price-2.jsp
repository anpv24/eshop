	...
	<section class="bg0 p-t-23 p-b-140">
		<div class="container">
					...
					<div
						...
						<div class="filter-col2 p-r-15 p-b-27">
							...
							<ul>
								...
								<li class="p-b-6"><a href="/eShopOnWeb/searchPrice?action=price & id=low"
								...
								<li class="p-b-6"><a href="/eShopOnWeb/searchPrice?action=price & id=high"
			...
			<div class="row isotope-grid">
				<c:forEach items="${requestScope.iphone2}" var="product">
