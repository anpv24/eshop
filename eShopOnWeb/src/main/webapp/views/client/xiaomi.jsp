		...
		<div class="container">
			...
			<div class="flex-w flex-sb-m p-b-52">
				<div class="flex-w flex-l-m filter-tope-group m-tb-10">
					...
					<a class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5"
						href="/eShopOnWeb/searchButton?action=iphone&id=oppo">Oppo</a>

					<a class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5"
						href="/eShopOnWeb/searchButton?action=iphone&id=samsung">Samsung</a>

					<a class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5 how-active1"
						href="/eShopOnWeb/searchButton?action=iphone&id=xiaomi">Xiaomi</a>
				</div>
					...
					<div
						...
						<div class="filter-col2 p-r-15 p-b-27">
							...
							<ul>
								...
								<li class="p-b-6"><a href="#"
									class="filter-link stext-106 trans-04"> 0đ - 2.000.000đ </a></li>

								<li class="p-b-6"><a href="#"
									class="filter-link stext-106 trans-04"> 2.000.000đ - 5.000.000đ </a></li>

								<li class="p-b-6"><a href="#"
									class="filter-link stext-106 trans-04"> 5.000.000đ - 10.000.000đ </a>
								</li>
			...
			<div class="row isotope-grid">
				<c:forEach items="${requestScope.xiaomi}" var="product">
					<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
						<!-- Block2 -->
						<div class="block2">
							<div class="block2-pic hov-img0">
								<img src="${url}/images/${ProductImageDAO.getById(product.productId)}" alt="IMG-PRODUCT">
							...
							<div class="block2-txt flex-w flex-t p-t-14">
								<div class="block2-txt-child1 flex-col-l ">
									<a href="product-detail.html"
										...
										${product.productName} </a> Price: <fmt:formatNumber type="number" maxFractionDigits="2" 
