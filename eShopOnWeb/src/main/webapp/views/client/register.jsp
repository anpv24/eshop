          ...
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="views/admin/index.jsp" class="logo d-flex align-items-center w-auto">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Điền thông tin cá nhân của bạn để tạo tài khoản</p>
                 ...
                 <form class="row g-3 needs-validation" novalidate action="register" method="post">
                    ...
                    <div class="col-12">
					 ...
					 <div class="col-12">
                      <label for="yourPassword" class="form-label">Họ và tên</label>
                    ...
                    <div class="col-12">
                     ...
                     <div class="col-12">
                      <label for="yourPassword" class="form-label">Số điện thoại</label>
                      <input type="text" name="phone" class="form-control" id="yourPhone" required>
                      <div class="invalid-feedback">Vui lòng nhập mật khẩu!</div>
                    </div>
                     <div class="col-12">
                      <label for="yourPassword" class="form-label">Địa chỉ</label>
                    ...
                    <div class="col-12">
                      <div class="form-check">
                        ...
                        <div class="invalid-feedback">Bạn phải đồng ý trước khi đăng ký.</div>
                      </div>
                    </div>
                    <div class="col-12">
