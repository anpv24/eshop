...
<%
	...
	if (cart_list != null) {
		...
		request.setAttribute("color", colorDAO);
		request.setAttribute("size", sizeDAO);
		request.setAttribute("image", iDao);
...
<body class="animsition">
			...
			<div class="header-cart-content flex-w js-pscroll">
				...
				<div class="w-full">
					...
					<div class="header-cart-buttons flex-w w-full">
						<a href="/eShopOnWeb/views/client/cart.jsp"
							class="flex-c-m stext-101 cl0 size-107 bg3 bor2 hov-btn3 p-lr-15 trans-04 m-r-8 m-b-10">
							View Cart </a> <a href="/eShopOnWeb/views/client/cart.jsp"
	...
	<!-- Shoping Cart -->
	<form action="${pageContext.request.contextPath}/cart-check-out" method="post" class="bg0 p-t-75 p-b-85">
		<div class="container">
			<div class="row">
					...
					<div class="m-l-25 m-r--38 m-lr-0-xl">
						<div class="wrap-table-shopping-cart">
							<table class="table-shopping-cart">
								...
								<c:set value="${image}" var="image"></c:set>
								<c:forEach items="${cartProduct}" var="cart">
									<tr class="table_row">
										<td class="column-1">
											<div class="how-itemcart1">
												<img src="${url}/images/${image.getById(cart.getProductId()).imagePath}" alt="IMG">
											</div>
										</td>
										<td class="column-2">${cart.getProductName()}</td>
										<td class="column-3"><fmt:formatNumber type="number" maxFractionDigits="2" value="${cart.getPrice()}" />đ</td>
										<td class="column-4">
										
											<div class="wrap-num-product flex-w m-l-auto m-r-0">
												<div
													class="btn-num-product-down cl8 hov-btn3 trans-04 flex-c-m">
													<a class="btn btn-sm btn-decre" href="/eShopOnWeb/quantity-inc-dec?action=dec&id=${cart.getProductId()}"><i class="fs-16 zmdi zmdi-minus"></i></a> 
												...
												<div
													...
													<a class="btn bnt-sm btn-incre" href="/eShopOnWeb/quantity-inc-dec?action=inc&id=${cart.getProductId()}"><i class="fs-16 zmdi zmdi-plus"></i></a> 
													
												</div>
											</div>
										</td>
										<td class="column-5"><fmt:formatNumber type="number" maxFractionDigits="2" value="${cart.getPrice()*cart.getQuantity()}" />đ </td>
										<td><a href="/eShopOnWeb/remove-from-cart?id=${cart.getProductId()}" class="btn btn-sm btn-danger mr-2">Remove</a></td>
									</tr>
								</c:forEach>
					...
					<div
						...
						<div class="flex-w flex-t bor12 p-t-15 p-b-30">
							<div class="size-208 w-full-ssm">
								<span class="stext-110 cl2">Calculate Shipping: </span>
							</div>
							...
							<div class="size-209 p-r-18 p-r-0-sm w-full-ssm">
								...
								<div class="p-t-15">
									...
									<div class="bor8 bg0 m-b-12">
										...
										<input class="stext-111 cl8 plh3 size-111 p-lr-15" type="date" name="bookingDate" required>
									</div>

									<div class="bor8 bg0 m-b-22">
										<label>Ngày giao mong muốn</label>
										<input class="stext-111 cl8 plh3 size-111 p-lr-15" type="date" name="deliveryDate" required>
									</div>
									<div class="rs1-select2 rs2-select2 bor8 bg0 m-b-12 m-t-9">
										<select class="js-select2" name="shippingWay" required>
											<option value="" disabled selected>Choose a delivery method</option>
									...
									<div class="bor8 bg0 m-b-22">
										<label>Ghi chú</label>
										<textarea name="note" class="form-control stext-111 cl8 plh3 size-111 p-lr-15" required></textarea>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="flex-w flex-t p-t-27 p-b-33">
							...
							<div class="size-209 p-t-1">
								<span class="mtext-110 cl2"> <fmt:formatNumber type="number" maxFractionDigits="2" value="${(total>0)?total:0}" />đ </span>
							</div>
						</div>
