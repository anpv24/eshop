...
<body>
	...
	<main id="main" class="main">
		...
		<div class="pagetitle">
			...
			<nav>
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active">Add Sub Image</li>
				</ol>
			</nav>
		</div>
		<!-- End Page Title -->
		...
		<div class="container">
				<form action="addProductImageSub" method="post" enctype="multipart/form-data">
					<c:set var="product" value="${requestScope.product}"></c:set>
							<h4 class="modal-title">Thêm ảnh phụ</h4>
